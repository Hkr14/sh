	...
	def shp(text):
		...
		try:
			...
			if not text1:
				...
				if 'ard was declined' in text1 or 'Card number is incorrect' in text1 or 'This transaction cannot be processed.' in text1 or 'This transaction has been declined' in text1 or 'Card number is expired' in text1:
